...
public class Camera2BasicFragment extends Fragment
    ...
    private String MODEL_FILE = "squeezenet.pb";
    private String LABEL_FILE = "labels.json";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //initial classifier class load label and labels
    }
    ...
    private void classifyFrame() {
        ...
        for (Classifier.Recognition item : results) {
            SpannableString result = new SpannableString(String.format("%s: %4.2f\n", item.getTitle(), item.getconfidencee()));
            int color;
            if (item.getconfidencee()>GOOD_PROB_THRESHOLD){
                color = android.graphics.Color.WHITE;
            }else{
                color = SMALL_COLOR;
            }
            result.setSpan(new ForegroundColorSpan(color), 0, result.length(), 0);
            textToShow.insert(0,result);
        }
